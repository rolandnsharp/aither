...
-   The `helperCounter` is reset to `0` at the beginning of every `register` call.
...
- [CORE_VISION.md](../CORE_VISION.md) - The fundamental design principles
- [STATE_OBJECT.md](../STATE_OBJECT.md) - Complete reference for the `s` object
- [HELPERS.md](../HELPERS.md) - Guide to using helper functions
- [history/](./history/) - Architectural evolution and design decisions
